...
const Client = require("./Template/models/client");
const Account = require("./Template/models/account");
...
// connecto to db
let connection = mongoose.connect('mongodb://localhost:27017/bankingSystem', {
